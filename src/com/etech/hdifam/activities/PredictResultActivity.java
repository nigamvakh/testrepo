...
public class PredictResultActivity extends Activity {
	private final String tag = "PredictResultActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.predictresultactivity);
	...
	public class PostListener implements RequestListener {
		public void onComplete(final String response, final Object state) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					Toast.makeText(PredictResultActivity.this,"Message posted on wall successfully",Toast.LENGTH_SHORT).show();
				}
			});
		}
